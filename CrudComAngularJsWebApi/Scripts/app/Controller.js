app.controller("crudCtrl", function ($scope, crudService) {
    ...
    $scope.AdicionarAtualizarCelular = function () {
        ...
        if (valorAcao == "Atualizar") {
            ...
            celularData.then(function (data) {
                ...
                $scope.divCelular = false;
                if (data.status == 200) {
                    toastr["warning"]("Celular alterado com sucesso!", "DevMedia - CRUD com MVC e AngularJS");
                }
            }, function () {
    ...
    $scope.excluirCelular = function (celular) {
        ...
        celularData.then(function (data) {
            if (data.status == 200) {
                toastr["error"]("Celular excluído com sucesso!", "DevMedia - CRUD com MVC e AngularJS ");
            }
            obterCelulares();
        }, function () {
            toastr["error"]("Erro ao exluir", "DevMedia - CRUD com MVC e AngularJS ");
        });
    }
